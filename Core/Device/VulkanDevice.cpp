...
namespace Unknown3d {
	...
	VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
		if (capabilities.currentExtent.width != UINT32_MAX) {
			...
			int width, height;
#ifdef WIN32
			glfwGetFramebufferSize(static_cast<GLFWwindow*>(WindowMgr::Instance().getWindowIns()->getWindowHandle()), &width, &height);
#endif
	...
	void* VulkanDevice::getWindowIns()
	{
#ifdef WIN32
		window_ins = WindowMgr::Instance().getWindowIns()->getWindowHandle();
#endif
		return window_ins;
	}
...
#ifdef WIN32
		glfwGetFramebufferSize(static_cast<GLFWwindow*>(getWindowIns()), &width, &height);
	...
	VkShaderModule VulkanDevice::createShaderModule(VkDevice device, const std::vector<char>& code) 
	{
